...
[![Download](https://api.bintray.com/packages/swallowsonny/ext/serialhelper/images/download.svg?version=1.0.2) ](https://bintray.com/swallowsonny/ext/serialhelper/1.0.2/link)
### 功能简介
- 框架处理权限请求问题
- 波特率设置
- 数据位设置
...
```
implementation 'com.swallowsonny:serialhelper:1.0.2'
```
